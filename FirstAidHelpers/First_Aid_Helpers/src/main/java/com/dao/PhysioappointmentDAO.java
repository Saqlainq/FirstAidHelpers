...
public class PhysioappointmentDAO {
    private Connection conn;

    public PhysioappointmentDAO(Connection con) {
        super();
        this.conn = con;
    }

    public boolean addAppointment(Physioappointment pa) {
        boolean f = false;
        try {
            String sql = "INSERT INTO physioappointment(fullname, appoindate, appointime, email, phno, area, city, state, postcode) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
