...
public class Physioappointment {
	 private int id;
		...
		public Physioappointment( String fullName, String appoinDate, String appoinTime, String email,
				String phNo, String area, String city, String state, String postcode) {
			super();
